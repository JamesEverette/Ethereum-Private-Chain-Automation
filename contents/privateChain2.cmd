...
geth --identity "privateChain" --rpc --rpcport "8081" --rpccorsdomain "*" --datadir "%USERPROFILE%\Desktop\blockchain\privateChain" --port "30304" --rpcapi "db,eth,net,web3" --networkid 1900 --nodiscover init %USERPROFILE%\Desktop\blockchain\customGenesis.json
)

start cmd /k geth --identity "privateChain" --rpc --rpcport "8081" --rpccorsdomain "*" --datadir "%USERPROFILE%\Desktop\blockchain\privateChain" --port "30304" --targetgaslimit --rpcapi "db,eth,net,web3" --networkid 1900 --nodiscover console
